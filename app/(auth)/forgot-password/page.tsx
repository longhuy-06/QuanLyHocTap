  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-6 bg-background-light dark:bg-background-dark relative overflow-hidden">
      ...
      <div className="w-full max-w-md mx-auto relative z-10 flex flex-col items-center">
        {/* Brand Section - Synced with Login/Register */}
        <div className="flex flex-col items-center mb-10 animate-fade-in-up">
           <div className="relative mb-6">
              <div className="h-20 w-20 bg-gradient-to-br from-primary to-indigo-600 rounded-[28px] flex items-center justify-center shadow-glow text-white transform rotate-3 scale-110">
           ...
           <p className="text-gray-400 font-bold text-xs uppercase tracking-[0.3em] mt-2">Khôi phục quyền truy cập</p>
        </div>
